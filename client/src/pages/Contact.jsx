...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-[#0a0e1a] via-[#0f1419] to-[#1a1f2e] text-white pt-24 pb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 pt-8">
              ...
              <div className="flex items-start gap-4 group">
                <div className="w-12 h-12 bg-gray-800/50 border border-gray-700/50 rounded-lg flex items-center justify-center group-hover:border-blue-500 transition-colors">
                ...
                <div>
                  ...
                  <a href="mailto:simon@example.com" className="text-white hover:text-blue-400 transition-colors text-lg">
                    simon.ooko@example.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <a href="tel:+254700000000" className="text-white hover:text-blue-400 transition-colors text-lg">
                    +254 700 000 000
                  </a>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex gap-4">
                {[
                  { name: 'GitHub', href: 'https://github.com/simonooko', icon: (
                  ...
                  { name: 'LinkedIn', href: 'https://linkedin.com/in/simonooko', icon: (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
